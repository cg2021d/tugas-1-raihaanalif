function main(){
    ...
    const vertices = {
        ...
        ...titik.T1, ...titik.color,
        ...titik.U1, ...titik.color,
        ...titik.V1, ...titik.color,
        ...titik.W1, ...titik.color,
        ...titik.Z1, ...titik.color,

        ...titik.A2, ...titik.color,
        ...titik.B2, ...titik.color,
        ...titik.C2, ...titik.color,
        ...titik.D2, ...titik.color,
        ...titik.E2, ...titik.color,
        ...titik.F2, ...titik.color,
        ...titik.G2, ...titik.color,
        ...titik.H2, ...titik.color,
